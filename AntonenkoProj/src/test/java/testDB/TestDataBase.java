...
public class TestDataBase {
    ...
    public void testWithDataBase() throws SQLException {
        ...
        database.modifyTable("INSERT INTO seleniumTable VALUES (2,'AntElena','passAnt')");
        logger.info(database.selectTable("select * from seleniumTable where login='AntElena'"));
