...
/**
 * Created by Администратор on 22.10.2017.
 */
public class LogInWithOutPageObject {
    ...
    public void tearDown() {
        ...
        public void validLogin(){
            ...
            // driver.findElement(By.xpath(локатор закрытого дропдауна).click();
            //driver.findElement(By.xpath(локатор строки) .click();
        ...
        public void invalidLogin () {
            ...
            Assert.assertTrue("message",
             driver.findElement(By.xpath(".//div[@class='pull-left image']//img[@class='img-circle']")).isDisplayed());
       }
    }
