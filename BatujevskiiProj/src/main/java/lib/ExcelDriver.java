...
public class ExcelDriver {
	...
	public static Map getMultipleData(String dataFileName, String sheetName, int columnNumber) throws IOException {
		Map<String, String> testData = new HashMap<String, String>(); // берем лист и получаем данные из нужной колонки..имеем мапку
    ...
    // в первой колонке ключик..во второй значение..остальное - не важно
	 ...
	 * data values in the test.
	 */
	// строка ключей потомстрока данных....
